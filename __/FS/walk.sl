...
private define fswalk (w, start)
{
  ...
  ifnot (stat_is ("dir", st.st_mode))
   	throw __Error, "FSwalkInvalidParmError::" + _function_name +
...
{
  variable followlinks = (0 == qualifier_exists ("uselstat") || (qualifier_exists ("followlinks") &&
...
private define walk (dir, dir_method, file_method)
{
